...
<?php
	if($administracion == 'Administrador'){
		...
		echo "<div class='col-sm-12 col-md-12 col-xl-12'><h3>Usuarios</h3></div><hr>";
			//Tabla de usuarios:
			...
			while ($z = mysql_fetch_row ($select)) {
				...
				echo "<td class='valores'><form method='post' action='modificar-usuario.php' align='center' name='formulario_usuario'>";
				echo "<input type='hidden' value='".$array[$a][0]."' name='mod'>";
				echo "<input name='accept' type='submit' value='M' align='center'>";
				echo "</input>";
				echo "</form></td>";
				echo "<td class='valores'><form method='post' action='script_baja.php' align='center' name='formulario_baja'>";
